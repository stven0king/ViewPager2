...
class BrowseActivity : ListActivity() {
    ...
    private fun getData(): List<Map<String, Any>> {
        ...
        myData.add(mapOf("title" to "Collapsing ViewPager2 with Nested RecyclerViews",
            "intent" to activityToIntent(CollapsingParallelNestedScrollingActivity::class.java.name)))
        return myData
    }
